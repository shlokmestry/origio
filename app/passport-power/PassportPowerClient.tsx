...
const FUN_FACTS = [
  ...
  { flag: "🇲🇨", text: "Monaco has a population of just 36,000 yet its passport unlocks more destinations than Russia or China." },
  { flag: "🇨🇳", text: "China's passport score has nearly doubled since 2015, driven by bilateral visa-waiver agreements under Belt and Road diplomacy." },
