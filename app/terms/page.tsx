...
const SECTIONS = [
  ...
  },
  {
    ...
    body: 'Origio is a relocation research tool that provides informational data on salaries, cost of living, visa routes, and quality of life across 58 countries. It is designed to help you research and explore options — it is not financial, legal, or immigration advice.\n\nWe do our best to keep data accurate and up to date, but we make no guarantees about the completeness, accuracy, or timeliness of any information. Always verify critical information with official government sources before making any relocation decision.',
  },
  {
    n: '3',
    title: 'Your account',
