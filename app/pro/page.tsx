...
function XIcon() {
  return (
    <span style={{
      flexShrink: 0, width: 16, height: 16, border: '1.5px solid #2a2a2a',
...
// ── Origio globe wireframe — functional, not decorative ───────────────────
function GlobeWireframe() {
  return (
    <div style={{ position: 'absolute', right: -80, top: '50%', transform: 'translateY(-50%)', pointerEvents: 'none', opacity: 0.18 }}>
      <svg viewBox="-360 -360 720 720" fill="none" style={{ width: 600, height: 600 }}>
        <circle cx="0" cy="0" r="360" stroke="#00ffd5" strokeWidth="1"/>
        <ellipse cx="0" cy="0" rx="60"  ry="360" stroke="#00ffd5" strokeWidth="0.8"/>
        <ellipse cx="0" cy="0" rx="180" ry="360" stroke="#00ffd5" strokeWidth="0.8"/>
        <ellipse cx="0" cy="0" rx="300" ry="360" stroke="#00ffd5" strokeWidth="0.8"/>
        <ellipse cx="0" cy="-120" rx="339" ry="30" stroke="#00ffd5" strokeWidth="0.8"/>
        <ellipse cx="0" cy="0"    rx="360" ry="40" stroke="#00ffd5" strokeWidth="1.2"/>
        <ellipse cx="0" cy="120"  rx="339" ry="30" stroke="#00ffd5" strokeWidth="0.8"/>
        <ellipse cx="0" cy="240"  rx="249" ry="20" stroke="#00ffd5" strokeWidth="0.8"/>
        <ellipse cx="0" cy="-240" rx="249" ry="20" stroke="#00ffd5" strokeWidth="0.8"/>
        {[[-160,-120],[80,-80],[220,-200],[-240,-60],[300,-40],[120,160],[-80,200]].map(([cx,cy],i) => (
          <g key={i}>
            <circle cx={cx} cy={cy} r="6" fill="#00ffd5" opacity="0.8"/>
            <circle cx={cx} cy={cy} r="14" stroke="#00ffd5" strokeWidth="0.8" opacity="0.4"/>
          </g>
        ))}
      </svg>
    </div>
...
export default function ProPage() {
  ...
  const eyebrow: React.CSSProperties = { fontSize: 10, fontWeight: 800, letterSpacing: '0.2em', textTransform: 'uppercase', color: '#888880' }
  const btnPrimary: React.CSSProperties = {
    background: '#00ffd5', color: '#0a0a0a', fontWeight: 800, textTransform: 'uppercase',
    letterSpacing: '0.15em', fontSize: 11, border: '2px solid #f0f0e8',
    boxShadow: '4px 4px 0 #f0f0e8', display: 'inline-flex', alignItems: 'center',
    justifyContent: 'center', cursor: 'pointer', padding: '14px 28px',
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0a0a0a', color: '#f0f0e8', fontFamily: 'inherit', overflowX: 'hidden' }}>
      ...
      <style>{`
        .cta-hover:hover { transform: translate(2px,2px); box-shadow: 2px 2px 0 #f0f0e8 !important; }
      ...
      {/* ── NAV ── */}
      <nav style={{ position: 'sticky', top: 0, zIndex: 50, background: 'rgba(10,10,10,0.95)', backdropFilter: 'blur(8px)', borderBottom: '1px solid #1a1a1a' }}>
        <div style={{ maxWidth: 1152, margin: '0 auto', padding: '0 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 56 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 24 }}>
            <a href="#features" style={{ ...eyebrow, textDecoration: 'none', color: '#888880' }}>Features</a>
            <a href="#compare"  style={{ ...eyebrow, textDecoration: 'none', color: '#888880' }}>Compare</a>
      ...
      {/* ── HERO — asymmetric, left text + right globe wireframe ── */}
      <section style={{ position: 'relative', overflow: 'hidden', borderBottom: '1px solid #1a1a1a', minHeight: 480, display: 'flex', alignItems: 'center' }}>
        <GlobeWireframe />
        <div style={{ maxWidth: 1152, margin: '0 auto', padding: '80px 24px', width: '100%' }}>
          ...
          <div style={{ maxWidth: 560 }}>
            ...
            <p style={{ fontSize: 15, color: '#888880', lineHeight: 1.7, maxWidth: 420, marginBottom: 36 }}>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 24 }}>
              {['No subscription', 'Secure via Stripe', 'Yours forever'].map(t => (
                <span key={t} style={{ ...eyebrow, display: 'flex', alignItems: 'center', gap: 6 }}>
                  <span style={{ width: 4, height: 4, background: '#00ffd5', display: 'inline-block' }} />
                  {t}
                </span>
              ))}
            </div>
      ...
      {/* ── PRICE CARD ── */}
      <section id="pricing" style={{ padding: '80px 24px', borderBottom: '1px solid #1a1a1a' }}>
        <div style={{ maxWidth: 1152, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 0, border: '1px solid #1a1a1a' }}>
          {/* Free column */}
          <div style={{ padding: '40px', borderRight: '1px solid #1a1a1a' }}>
            <p style={{ ...eyebrow, marginBottom: 16 }}>Free</p>
            <div style={{ fontFamily: 'var(--font-heading, sans-serif)', fontSize: 56, fontWeight: 900, lineHeight: 1, letterSpacing: '-0.03em', marginBottom: 8 }}>
              €0
            </div>
            <p style={{ ...eyebrow, color: '#444', marginBottom: 32 }}>Forever</p>
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: 12 }}>
              {['Top 3 matches', 'Salary by role', 'Basic visa & cost summary', '3 quiz runs'].map(f => (
                <li key={f} style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  <CheckIcon accent={false} />
                  <span style={{ fontSize: 13, color: '#888880' }}>{f}</span>
                </li>
              ))}
              {['Full reports', 'Take-home calculator', 'Visa checklist', '3-country comparison'].map(f => (
                <li key={f} style={{ display: 'flex', alignItems: 'center', gap: 10, opacity: 0.35 }}>
                  <XIcon />
          ...
          {/* Pro column */}
          <div style={{ padding: '40px', background: '#0d0d0d', borderLeft: '2px solid #00ffd5' }}>
            <p style={{ ...eyebrow, color: '#00ffd5', marginBottom: 16 }}>Pro</p>
            <div style={{ fontFamily: 'var(--font-heading, sans-serif)', fontSize: 56, fontWeight: 900, lineHeight: 1, letterSpacing: '-0.03em', marginBottom: 8 }}>
              €19<span style={{ fontSize: 28, color: '#888880' }}>.99</span>
            </div>
            <p style={{ ...eyebrow, color: '#00ffd5', marginBottom: 8 }}>Once · forever · no renewal</p>
            <p style={{ fontSize: 11, color: '#555', marginBottom: 32, textDecoration: 'line-through' }}>€200+ for an immigration consult</p>
            ...
            <p style={{ textAlign: 'center', fontSize: 10, fontWeight: 700, color: '#444', marginTop: 12, letterSpacing: '0.1em', textTransform: 'uppercase' }}>
      ...
      <section id="features" style={{ padding: '80px 24px', borderBottom: '1px solid #1a1a1a' }}>
        <div style={{ maxWidth: 720, margin: '0 auto' }}>
          <p style={{ ...eyebrow, marginBottom: 16 }}>What Pro includes</p>
          <h2 style={{
            fontFamily: 'DM Serif Display, Georgia, serif',
          ...
          <div>
            {PRO_FEATURES.map((f, i) => (
              <div key={f.num} style={{ display: 'grid', gridTemplateColumns: '48px 1fr', gap: 20, padding: '28px 0', borderBottom: i < PRO_FEATURES.length - 1 ? '1px solid #111' : 'none' }}>
                <span style={{ fontFamily: 'var(--font-heading, sans-serif)', fontSize: 28, fontWeight: 900, color: '#1a1a1a', lineHeight: 1 }}>{f.num}</span>
                <div>
                  ...
                  <p style={{ fontSize: 13, color: '#666660', lineHeight: 1.6 }}>{f.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section id="compare" style={{ padding: '80px 24px', borderBottom: '1px solid #1a1a1a' }}>
        <div style={{ maxWidth: 768, margin: '0 auto' }}>
          <p style={{ ...eyebrow, marginBottom: 16 }}>Free vs Pro</p>
          <h2 style={{
            fontFamily: 'DM Serif Display, Georgia, serif',
          ...
          <div style={{ border: '1px solid #1a1a1a' }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 120px 120px', background: '#0d0d0d', borderBottom: '1px solid #1a1a1a' }}>
              ...
              <div style={{ padding: '16px 12px', borderLeft: '2px solid #00ffd5', textAlign: 'center', background: 'rgba(0,255,213,0.03)' }}>
            ...
            {COMPARE_ROWS.map((row, i) => (
              <div key={row.feature} className="compare-row-hover"
                ...
                <div style={{ padding: '14px 12px', borderLeft: '2px solid #00ffd5', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(0,255,213,0.02)' }}>
      ...
      <section id="faq" style={{ padding: '80px 24px', borderBottom: '1px solid #1a1a1a' }}>
        <div style={{ maxWidth: 720, margin: '0 auto' }}>
          <p style={{ ...eyebrow, marginBottom: 16 }}>Common questions</p>
          <h2 style={{
            fontFamily: 'DM Serif Display, Georgia, serif',
            fontSize: 'clamp(28px, 4vw, 40px)',
            fontWeight: 400,
            ...
            marginBottom: 48,
            color: '#f0f0e8',
          }}>Before you upgrade.</h2>
          <div style={{ border: '1px solid #1a1a1a' }}>
            {FAQS.map((faq, i) => (
              <div key={i} style={{ borderBottom: i < FAQS.length - 1 ? '1px solid #111' : 'none' }}>
                <button onClick={() => setOpenFaq(openFaq === i ? null : i)} className="faq-hover"
                  style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 20px', textAlign: 'left', background: 'transparent', border: 'none', cursor: 'pointer', transition: 'background .12s ease' }}>
                ...
                {openFaq === i && (
                  <div style={{ padding: '16px 20px', fontSize: 12, color: '#666660', lineHeight: 1.7, borderTop: '1px solid #111' }}>
                    {faq.a}
                  </div>
                )}
              </div>
      ...
      {/* ── FINAL CTA — asymmetric, left-text + right-button ── */}
      <section style={{ padding: '80px 24px' }}>
        <div style={{ maxWidth: 1152, margin: '0 auto' }}>
          <div style={{ border: '1px solid #2a2a2a', padding: 'clamp(40px, 5vw, 64px)', boxShadow: '4px 4px 0 #00ffd5', display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', gap: 32 }}>
            <div>
              <h2 style={{
                fontFamily: 'DM Serif Display, Georgia, serif',
                ...
                marginBottom: 8,
                color: '#f0f0e8',
              }}>Get the full ranking.</h2>
              <p style={{ fontSize: 13, color: '#666660' }}>€19.99. No subscription.</p>
            </div>
            <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: 16 }}>
              ...
              <Link href="/wizard" style={{ fontSize: 11, fontWeight: 700, color: '#666660', textDecoration: 'none', textTransform: 'uppercase', letterSpacing: '0.1em' }}
