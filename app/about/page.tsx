...
function NewspaperSpoof() {
  ...
  const headlines = [
    ...
    },
    {
      ...
      us: "100 cities · 58 countries ranked by your actual priorities, not strangers' vibes",
    },
    {
          ...
          <div style={{ maxWidth: 720, margin: "0 auto" }}>
            ...
            <FadeIn delay={240}>
              <p style={{ fontFamily: "system-ui, sans-serif", fontSize: 17, lineHeight: 1.75, color: "rgba(240,240,232,0.72)", margin: 0 }}>
                ...
                <strong style={{ color: "#f0f0e8" }}>Find My Country</strong> quiz asks 8 questions about your priorities, job, passport, and budget — then scores all 58 countries and gives you a personalised ranked list.
              </p>
            </FadeIn>
          </div>
        </section>
