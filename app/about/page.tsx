          ...
          <div style={{ maxWidth: 720, margin: "0 auto" }}>
            ...
            <FadeIn delay={240}>
              <p style={{ fontFamily: "system-ui, sans-serif", fontSize: 17, lineHeight: 1.75, color: "rgba(240,240,232,0.72)", margin: 0 }}>
                ...
                <strong style={{ color: "#f0f0e8" }}>Find My Country</strong> quiz asks 8 questions about your priorities, job, passport, and budget — then scores all 45 countries and gives you a personalised ranked list.
              </p>
            </FadeIn>
          </div>
        </section>
