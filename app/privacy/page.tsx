        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 56 }}>
          ...
          <section>
            ...
            <p style={{ fontSize: 15, color: S.dim, lineHeight: 1.8, margin: '0 0 12px' }}>
              Origio is a relocation research tool operated by Shlok Mestry, based in Ireland. We help people compare salaries, visas, cost of living and quality of life across 48 countries.
            </p>
