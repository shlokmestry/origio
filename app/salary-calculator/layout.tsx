...
export const metadata: Metadata = {
  ...
  description:
    "Calculate your real take-home salary after tax in 48 countries. Compare net pay for 20 roles across the UK, US, Germany, Singapore, UAE and more.",
  keywords: [
    "salary calculator",
  ...
  openGraph: {
    ...
    description:
      "See your real net salary after tax in 48 countries. 20 roles, real market rates, accurate tax calculations.",
