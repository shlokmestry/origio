    ...
    <Link href="/cities" style={{ textDecoration: "none", display: "block", marginTop: 18 }}>
      ...
      >
        ...
        <div style={{
          ...
          Compare rent, food &amp; lifestyle costs across 66 cities →
        </div>
      </div>
    </Link>
  );
