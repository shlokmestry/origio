...
const REMOTE_DATA: Record<string, { stars: number; badge: string }> = {
  ...
  ZA: { stars: 3, badge: "Digital Nomad Visa · English" },
  EE: { stars: 4, badge: "e-Residency · EU · low tax" },
  ID: { stars: 3, badge: "Second Home Visa · Bali" },
  QA: { stars: 4, badge: "0% tax · QFC free zone" },
  MT: { stars: 4, badge: "EU · Nomad Residence Permit" },
};
...
const FX_TO_USD: Record<string, number> = {
  ...
  IS: 0.0081, MT: 1.09, SA: 0.2667, QA: 0.2747, IL: 0.3297,
  CL: 0.00107, PH: 0.018, SI: 1.09, LU: 1.09, BG: 1.09,
};
...
const TAX_DATA = {
  ...
  EE: { currency:"EUR", symbol:"€",   usdSymbol:"$", name:"Estonia",             flag:"🇪🇪",
    bands:[{min:0,max:Infinity,rate:.20}],
    socialSecurity:.016 },
  CY: { currency:"EUR", symbol:"€",   usdSymbol:"$", name:"Cyprus",              flag:"🇨🇾",
    personalAllowance:19500,
    bands:[{min:0,max:19500,rate:0},{min:19500,max:28000,rate:.20},{min:28000,max:36300,rate:.25},{min:36300,max:60000,rate:.30},{min:60000,max:Infinity,rate:.35}],
    socialSecurity:.083 },
  HU: { currency:"HUF", symbol:"Ft ", usdSymbol:"$", name:"Hungary",             flag:"🇭🇺",
    bands:[{min:0,max:Infinity,rate:.15}],
    socialSecurity:.185 },
  RO: { currency:"RON", symbol:"lei ",usdSymbol:"$", name:"Romania",             flag:"🇷🇴",
    bands:[{min:0,max:Infinity,rate:.10}],
    socialSecurity:.35 },
  RS: { currency:"RSD", symbol:"RSD ",usdSymbol:"$", name:"Serbia",              flag:"🇷🇸",
    bands:[{min:0,max:Infinity,rate:.10}],
    socialSecurity:.199 },
  ZA: { currency:"ZAR", symbol:"R",   usdSymbol:"$", name:"South Africa",        flag:"🇿🇦",
    rebate:17235,
    bands:[{min:0,max:237100,rate:.18},{min:237100,max:370500,rate:.26},{min:370500,max:512800,rate:.31},{min:512800,max:673000,rate:.36},{min:673000,max:857900,rate:.39},{min:857900,max:1817000,rate:.41},{min:1817000,max:Infinity,rate:.45}],
    socialSecurity:.01 },
  AR: { currency:"USD", symbol:"$",   usdSymbol:"$", name:"Argentina",           flag:"🇦🇷",
    bands:[{min:0,max:5000,rate:.05},{min:5000,max:20000,rate:.09},{min:20000,max:50000,rate:.14},{min:50000,max:Infinity,rate:.175}],
    socialSecurity:.17 },
  ID: { currency:"IDR", symbol:"Rp ", usdSymbol:"$", name:"Indonesia",           flag:"🇮🇩",
    personalDeduction:54000000,
    bands:[{min:0,max:60000000,rate:.05},{min:60000000,max:250000000,rate:.15},{min:250000000,max:500000000,rate:.25},{min:500000000,max:5000000000,rate:.30},{min:5000000000,max:Infinity,rate:.35}],
    socialSecurity:.03 },
  IS: { currency:"ISK", symbol:"kr",   usdSymbol:"$", name:"Iceland",             flag:"🇮🇸",
    bands:[{min:0,max:498122,rate:.3149},{min:498122,max:1398450,rate:.3799},{min:1398450,max:Infinity,rate:.4629}],
    socialSecurity:.04 },
  MT: { currency:"EUR", symbol:"€",   usdSymbol:"$", name:"Malta",                flag:"🇲🇹",
    bands:[{min:0,max:9100,rate:0},{min:9100,max:14500,rate:.15},{min:14500,max:60000,rate:.25},{min:60000,max:Infinity,rate:.35}],
    socialSecurity:.10 },
  SA: { currency:"SAR", symbol:"SAR ",usdSymbol:"$", name:"Saudi Arabia",         flag:"🇸🇦", bands:[],
    socialSecurity:.02 },
  QA: { currency:"QAR", symbol:"QAR ",usdSymbol:"$", name:"Qatar",                flag:"🇶🇦", bands:[],
    socialSecurity:0 },
  IL: { currency:"ILS", symbol:"₪",   usdSymbol:"$", name:"Israel",               flag:"🇮🇱",
    bands:[{min:0,max:84120,rate:.10},{min:84120,max:120720,rate:.14},{min:120720,max:228000,rate:.20},{min:228000,max:301200,rate:.31},{min:301200,max:560280,rate:.35},{min:560280,max:721560,rate:.47},{min:721560,max:Infinity,rate:.50}],
    socialSecurity:.12 },
  CL: { currency:"CLP", symbol:"CLP$",usdSymbol:"$", name:"Chile",                flag:"🇨🇱",
    bands:[{min:0,max:11400000,rate:0},{min:11400000,max:25400000,rate:.04},{min:25400000,max:42400000,rate:.08},{min:42400000,max:59300000,rate:.135},{min:59300000,max:76200000,rate:.23},{min:76200000,max:101600000,rate:.304},{min:101600000,max:262600000,rate:.355},{min:262600000,max:Infinity,rate:.40}],
    socialSecurity:.07 },
  PH: { currency:"PHP", symbol:"₱",   usdSymbol:"$", name:"Philippines",          flag:"🇵🇭",
    bands:[{min:0,max:250000,rate:0},{min:250000,max:400000,rate:.15},{min:400000,max:800000,rate:.20},{min:800000,max:2000000,rate:.25},{min:2000000,max:8000000,rate:.30},{min:8000000,max:Infinity,rate:.35}],
    socialSecurity:.08 },
  SI: { currency:"EUR", symbol:"€",   usdSymbol:"$", name:"Slovenia",             flag:"🇸🇮",
    bands:[{min:0,max:9210,rate:.16},{min:9210,max:27089,rate:.26},{min:27089,max:54178,rate:.33},{min:54178,max:78016,rate:.39},{min:78016,max:Infinity,rate:.50}],
    socialSecurity:.221 },
  LU: { currency:"EUR", symbol:"€",   usdSymbol:"$", name:"Luxembourg",           flag:"🇱🇺",
    bands:[{min:0,max:13230,rate:0},{min:13230,max:50000,rate:.20},{min:50000,max:100000,rate:.30},{min:100000,max:234871,rate:.39},{min:234871,max:Infinity,rate:.42}],
    socialSecurity:.1245 },
  BG: { currency:"EUR", symbol:"€",   usdSymbol:"$", name:"Bulgaria",             flag:"🇧🇬",
    bands:[{min:0,max:Infinity,rate:.10}],
    socialSecurity:.1378 },
};
...
const ROLE_SALARIES: Record<string, Record<string, number>> = {
  "Software Engineer":         { UK:75000,  US:130000, CA:110000, AU:120000, DE:72000,  IE:80000,  NL:75000,  SG:95000,  AE:280000, PT:35000,  MX:580000,   TH:1130000,  GR:35000,  CO:72000000,  PA:55000, KR:85000000,  CZ:1200000,  GE:70000,  VN:600000000,  HR:42000,  CR:28000000,  PL:180000,  AT:65000,  BE:72000,  BR:180000, DK:620000, FI:68000,  FR:52000,  IN:1800000, IT:40000,  JP:8000000,  MY:108000, NZ:110000, NO:780000, ES:42000,  SE:680000, CH:145000, EE:35000,  CY:38000,  HU:8400000,   RO:120000,  RS:2160000,   ZA:650000,  AR:24000,  ID:180000000,  IS:11500000, MT:48000, SA:210000, QA:175000, IL:320000, CL:18000000, PH:550000, SI:45000, LU:80000, BG:42000 },
  "Product Manager":           { UK:85000,  US:145000, CA:120000, AU:130000, DE:80000,  IE:90000,  NL:85000,  SG:110000, AE:320000, PT:40000,  MX:680000,   TH:1400000,  GR:42000,  CO:90000000,  PA:65000, KR:100000000, CZ:1400000,  GE:85000,  VN:750000000,  HR:50000,  CR:35000000,  PL:210000,  AT:76000,  BE:82000,  BR:200000, DK:720000, FI:76000,  FR:62000,  IN:2200000, IT:48000,  JP:9500000,  MY:130000, NZ:120000, NO:900000, ES:50000,  SE:790000, CH:170000, EE:34000,  CY:35000,  HU:7800000,   RO:108000,  RS:2160000,   ZA:600000,  AR:20000,  ID:180000000,  IS:12950000, MT:54000, SA:236000, QA:197000, IL:360000, CL:20300000, PH:620000, SI:50500, LU:90000, BG:47500 },
  "UX/UI Designer":            { UK:55000,  US:95000,  CA:85000,  AU:90000,  DE:58000,  IE:60000,  NL:60000,  SG:72000,  AE:200000, PT:28000,  MX:400000,   TH:840000,   GR:28000,  CO:55000000,  PA:45000, KR:68000000,  CZ:900000,   GE:50000,  VN:420000000,  HR:32000,  CR:21000000,  PL:130000,  AT:50000,  BE:55000,  BR:130000, DK:520000, FI:55000,  FR:44000,  IN:1200000, IT:30000,  JP:6500000,  MY:84000,  NZ:88000,  NO:620000, ES:35000,  SE:580000, CH:118000, EE:28000,  CY:27000,  HU:6000000,   RO:72000,   RS:1620000,   ZA:420000,  AR:16000,  ID:144000000,  IS:8880000, MT:37000, SA:162000, QA:135000, IL:247000, CL:13900000, PH:425000, SI:35000, LU:62000, BG:32500 },
  "Data Scientist":            { UK:70000,  US:125000, CA:105000, AU:110000, DE:70000,  IE:75000,  NL:72000,  SG:90000,  AE:260000, PT:32000,  MX:540000,   TH:1050000,  GR:34000,  CO:68000000,  PA:52000, KR:82000000,  CZ:1150000,  GE:65000,  VN:560000000,  HR:40000,  CR:26000000,  PL:170000,  AT:63000,  BE:70000,  BR:170000, DK:600000, FI:66000,  FR:52000,  IN:1700000, IT:38000,  JP:8500000,  MY:105000, NZ:105000, NO:760000, ES:42000,  SE:660000, CH:140000, EE:32000,  CY:33000,  HU:7200000,   RO:108000,  RS:2160000,   ZA:650000,  AR:20000,  ID:192000000,  IS:10930000, MT:45500, SA:200000, QA:166000, IL:304000, CL:17100000, PH:525000, SI:43000, LU:76000, BG:40000 },
  "DevOps Engineer":           { UK:72000,  US:128000, CA:108000, AU:115000, DE:74000,  IE:78000,  NL:76000,  SG:92000,  AE:270000, PT:33000,  MX:560000,   TH:1100000,  GR:36000,  CO:75000000,  PA:57000, KR:88000000,  CZ:1250000,  GE:72000,  VN:620000000,  HR:43000,  CR:29000000,  PL:185000,  AT:66000,  BE:73000,  BR:175000, DK:630000, FI:68000,  FR:54000,  IN:1900000, IT:40000,  JP:8800000,  MY:110000, NZ:108000, NO:780000, ES:44000,  SE:680000, CH:142000, EE:32000,  CY:32000,  HU:7800000,   RO:108000,  RS:2160000,   ZA:620000,  AR:20000,  ID:180000000,  IS:11430000, MT:47500, SA:209000, QA:174000, IL:318000, CL:17900000, PH:545000, SI:44500, LU:79500, BG:41500 },
  "Marketing Manager":         { UK:52000,  US:85000,  CA:75000,  AU:85000,  DE:55000,  IE:58000,  NL:58000,  SG:75000,  AE:200000, PT:25000,  MX:420000,   TH:700000,   GR:28000,  CO:48000000,  PA:48000, KR:60000000,  CZ:850000,   GE:45000,  VN:360000000,  HR:34000,  CR:16000000,  PL:110000,  AT:48000,  BE:55000,  BR:120000, DK:480000, FI:52000,  FR:42000,  IN:1000000, IT:30000,  JP:7000000,  MY:78000,  NZ:82000,  NO:600000, ES:32000,  SE:540000, CH:110000, EE:28000,  CY:28000,  HU:6000000,   RO:72000,   RS:1440000,   ZA:480000,  AR:16000,  ID:144000000,  IS:8500000, MT:35500, SA:155000, QA:129000, IL:236000, CL:13300000, PH:405000, SI:33000, LU:59000, BG:31000 },
  "Financial Analyst":         { UK:58000,  US:90000,  CA:78000,  AU:88000,  DE:60000,  IE:62000,  NL:62000,  SG:78000,  AE:220000, PT:26000,  MX:360000,   TH:780000,   GR:30000,  CO:45000000,  PA:50000, KR:65000000,  CZ:900000,   GE:48000,  VN:380000000,  HR:36000,  CR:18000000,  PL:120000,  AT:52000,  BE:58000,  BR:130000, DK:520000, FI:55000,  FR:44000,  IN:900000,  IT:32000,  JP:7500000,  MY:84000,  NZ:88000,  NO:640000, ES:36000,  SE:560000, CH:115000, EE:28000,  CY:28000,  HU:5400000,   RO:60000,   RS:1080000,   ZA:420000,  AR:14000,  ID:120000000,  IS:9220000, MT:38500, SA:168000, QA:140000, IL:257000, CL:14400000, PH:440000, SI:36000, LU:64000, BG:33500 },
  "Cybersecurity Analyst":     { UK:68000,  US:115000, CA:95000,  AU:105000, DE:68000,  IE:72000,  NL:70000,  SG:85000,  AE:250000, PT:30000,  MX:500000,   TH:980000,   GR:33000,  CO:65000000,  PA:54000, KR:78000000,  CZ:1100000,  GE:62000,  VN:520000000,  HR:40000,  CR:25000000,  PL:160000,  AT:61000,  BE:68000,  BR:160000, DK:580000, FI:63000,  FR:50000,  IN:1600000, IT:36000,  JP:8200000,  MY:100000, NZ:100000, NO:730000, ES:40000,  SE:630000, CH:130000, EE:35000,  CY:33000,  HU:8400000,   RO:108000,  RS:2160000,   ZA:620000,  AR:22000,  ID:192000000,  IS:10590000, MT:44000, SA:193000, QA:161000, IL:295000, CL:16600000, PH:505000, SI:41500, LU:73500, BG:38500 },
  "Sales Manager":             { UK:65000,  US:110000, CA:90000,  AU:100000, DE:65000,  IE:68000,  NL:65000,  SG:85000,  AE:240000, PT:28000,  MX:380000,   TH:800000,   GR:30000,  CO:50000000,  PA:52000, KR:64000000,  CZ:880000,   GE:46000,  VN:380000000,  HR:34000,  CR:17000000,  PL:120000,  AT:58000,  BE:64000,  BR:140000, DK:560000, FI:58000,  FR:46000,  IN:1000000, IT:32000,  JP:7200000,  MY:86000,  NZ:90000,  NO:680000, ES:36000,  SE:580000, CH:118000, EE:30000,  CY:28000,  HU:6600000,   RO:72000,   RS:1440000,   ZA:500000,  AR:16000,  ID:144000000,  IS:10020000, MT:42000, SA:183000, QA:153000, IL:279000, CL:15700000, PH:480000, SI:39000, LU:69500, BG:36500 },
  "HR Manager":                { UK:50000,  US:80000,  CA:72000,  AU:80000,  DE:52000,  IE:55000,  NL:55000,  SG:70000,  AE:190000, PT:24000,  MX:300000,   TH:660000,   GR:26000,  CO:40000000,  PA:42000, KR:55000000,  CZ:780000,   GE:38000,  VN:300000000,  HR:30000,  CR:14000000,  PL:100000,  AT:45000,  BE:50000,  BR:110000, DK:450000, FI:48000,  FR:38000,  IN:800000,  IT:28000,  JP:6000000,  MY:72000,  NZ:76000,  NO:580000, ES:28000,  SE:500000, CH:100000, EE:26000,  CY:25000,  HU:5400000,   RO:54000,   RS:1080000,   ZA:420000,  AR:12000,  ID:108000000,  IS:8080000, MT:33500, SA:148000, QA:123000, IL:225000, CL:12600000, PH:385000, SI:31500, LU:56000, BG:29500 },
  "AI / ML Engineer":          { UK:90000,  US:185000, CA:150000, AU:155000, DE:95000,  IE:100000, NL:92000,  SG:150000, AE:350000, PT:42000,  MX:720000,   TH:1600000,  GR:44000,  CO:100000000, PA:75000, KR:120000000, CZ:1600000,  GE:95000,  VN:900000000,  HR:55000,  CR:42000000,  PL:250000,  AT:82000,  BE:90000,  BR:220000, DK:800000, FI:85000,  FR:72000,  IN:2800000, IT:55000,  JP:11000000, MY:155000, NZ:148000, NO:1000000,ES:58000,  SE:860000, CH:185000, EE:38000,  CY:36000,  HU:9000000,   RO:120000,  RS:2700000,   ZA:700000,  AR:28000,  ID:216000000,  IS:14360000, MT:60000, SA:262000, QA:219000, IL:400000, CL:22500000, PH:685000, SI:56000, LU:100000, BG:52500 },
  "Cloud Architect":           { UK:85000,  US:170000, CA:140000, AU:148000, DE:90000,  IE:95000,  NL:88000,  SG:135000, AE:325000, PT:38000,  MX:680000,   TH:1500000,  GR:42000,  CO:95000000,  PA:70000, KR:110000000, CZ:1500000,  GE:88000,  VN:840000000,  HR:52000,  CR:38000000,  PL:230000,  AT:78000,  BE:85000,  BR:210000, DK:760000, FI:80000,  FR:68000,  IN:2500000, IT:52000,  JP:10500000, MY:145000, NZ:140000, NO:950000, ES:55000,  SE:820000, CH:175000, EE:36000,  CY:35000,  HU:8400000,   RO:108000,  RS:2160000,   ZA:650000,  AR:24000,  ID:192000000,  IS:13640000, MT:57000, SA:249000, QA:208000, IL:380000, CL:21300000, PH:650000, SI:53500, LU:95000, BG:50000 },
  "Dentist":                   { UK:82000,  US:180000, CA:165000, AU:175000, DE:80000,  IE:100000, NL:100000, SG:160000, AE:330000, PT:40000,  MX:600000,   TH:1800000,  GR:50000,  CO:80000000,  PA:80000, KR:130000000, CZ:1500000,  GE:80000,  VN:700000000,  HR:60000,  CR:45000000,  PL:200000,  AT:75000,  BE:90000,  BR:200000, DK:700000, FI:78000,  FR:70000,  IN:1800000, IT:55000,  JP:11000000, MY:140000, NZ:150000, NO:880000, ES:50000,  SE:760000, CH:180000, EE:35000,  CY:38000,  HU:7200000,   RO:84000,   RS:1620000,   ZA:700000,  AR:18000,  ID:180000000,  IS:13760000, MT:57500, SA:251000, QA:209000, IL:383000, CL:21500000, PH:660000, SI:54000, LU:96000, BG:50500 },
  "Physiotherapist":           { UK:43000,  US:82000,  CA:85000,  AU:90000,  DE:47000,  IE:52000,  NL:52000,  SG:68000,  AE:160000, PT:24000,  MX:280000,   TH:600000,   GR:26000,  CO:38000000,  PA:38000, KR:48000000,  CZ:700000,   GE:30000,  VN:240000000,  HR:28000,  CR:12000000,  PL:90000,   AT:40000,  BE:46000,  BR:100000, DK:420000, FI:42000,  FR:35000,  IN:600000,  IT:30000,  JP:5500000,  MY:55000,  NZ:82000,  NO:520000, ES:28000,  SE:470000, CH:90000,  EE:22000,  CY:22000,  HU:4200000,   RO:36000,   RS:864000,    ZA:300000,  AR:10000,  ID:84000000,  IS:7390000, MT:31000, SA:135000, QA:112000, IL:206000, CL:11600000, PH:355000, SI:29000, LU:51500, BG:27000  },
  "Psychologist":              { UK:46000,  US:95000,  CA:85000,  AU:95000,  DE:52000,  IE:57000,  NL:56000,  SG:70000,  AE:185000, PT:28000,  MX:300000,   TH:720000,   GR:28000,  CO:42000000,  PA:42000, KR:52000000,  CZ:800000,   GE:35000,  VN:280000000,  HR:32000,  CR:14000000,  PL:100000,  AT:44000,  BE:50000,  BR:110000, DK:460000, FI:48000,  FR:40000,  IN:700000,  IT:32000,  JP:6200000,  MY:62000,  NZ:88000,  NO:560000, ES:30000,  SE:510000, CH:100000, EE:25000,  CY:26000,  HU:4800000,   RO:48000,   RS:1080000,   ZA:400000,  AR:12000,  ID:108000000,  IS:8030000, MT:33500, SA:147000, QA:122000, IL:224000, CL:12600000, PH:385000, SI:31500, LU:56000, BG:29500 },
  "Renewable Energy Engineer": { UK:68000,  US:112000, CA:108000, AU:122000, DE:73000,  IE:67000,  NL:72000,  SG:92000,  AE:255000, PT:37000,  MX:480000,   TH:1050000,  GR:36000,  CO:60000000,  PA:55000, KR:80000000,  CZ:1100000,  GE:60000,  VN:520000000,  HR:42000,  CR:24000000,  PL:155000,  AT:62000,  BE:68000,  BR:155000, DK:580000, FI:64000,  FR:52000,  IN:1400000, IT:40000,  JP:8000000,  MY:95000,  NZ:105000, NO:720000, ES:42000,  SE:620000, CH:130000, EE:30000,  CY:28000,  HU:6600000,   RO:72000,   RS:1512000,   ZA:500000,  AR:16000,  ID:144000000,  IS:10690000, MT:44500, SA:195000, QA:163000, IL:297000, CL:16700000, PH:510000, SI:42000, LU:74500, BG:39000 },
  "Pilot":                     { UK:90000,  US:170000, CA:145000, AU:150000, DE:95000,  IE:85000,  NL:100000, SG:165000, AE:450000, PT:65000,  MX:900000,   TH:3200000,  GR:65000,  CO:180000000, PA:120000,KR:180000000, CZ:2500000,  GE:160000, VN:1800000000, HR:80000,  CR:70000000,  PL:380000,  AT:90000,  BE:95000,  BR:280000, DK:880000, FI:88000,  FR:85000,  IN:3500000, IT:75000,  JP:16000000, MY:200000, NZ:145000, NO:1200000,ES:70000,  SE:1000000,CH:200000, EE:65000,  CY:60000,  HU:18000000,  RO:240000,  RS:4320000,   ZA:900000,  AR:40000,  ID:600000000,  IS:14130000, MT:59000, SA:258000, QA:215000, IL:393000, CL:22100000, PH:675000, SI:55500, LU:98500, BG:51500 },
  "Graphic Designer":          { UK:41000,  US:72000,  CA:63000,  AU:70000,  DE:46000,  IE:45000,  NL:49000,  SG:56000,  AE:128000, PT:21000,  MX:240000,   TH:540000,   GR:22000,  CO:32000000,  PA:35000, KR:42000000,  CZ:620000,   GE:28000,  VN:240000000,  HR:26000,  CR:11000000,  PL:85000,   AT:38000,  BE:43000,  BR:90000,  DK:380000, FI:40000,  FR:32000,  IN:600000,  IT:24000,  JP:5200000,  MY:52000,  NZ:65000,  NO:480000, ES:24000,  SE:430000, CH:82000,  EE:20000,  CY:20000,  HU:4200000,   RO:48000,   RS:1080000,   ZA:260000,  AR:12000,  ID:84000000,  IS:6900000, MT:29000, SA:126000, QA:105000, IL:192000, CL:10800000, PH:330000, SI:27000, LU:48000, BG:25000  },
  "Biomedical Engineer":       { UK:55000,  US:112000, CA:98000,  AU:105000, DE:68000,  IE:68000,  NL:67000,  SG:90000,  AE:215000, PT:30000,  MX:380000,   TH:900000,   GR:30000,  CO:55000000,  PA:50000, KR:70000000,  CZ:950000,   GE:50000,  VN:380000000,  HR:35000,  CR:22000000,  PL:135000,  AT:60000,  BE:65000,  BR:150000, DK:560000, FI:62000,  FR:50000,  IN:1400000, IT:38000,  JP:8500000,  MY:95000,  NZ:100000, NO:700000, ES:38000,  SE:600000, CH:128000, EE:26000,  CY:26000,  HU:5400000,   RO:60000,   RS:1080000,   ZA:400000,  AR:14000,  ID:120000000,  IS:9840000, MT:41000, SA:180000, QA:150000, IL:274000, CL:15400000, PH:470000, SI:38500, LU:68500, BG:36000 },
  "Supply Chain Manager":      { UK:64000,  US:110000, CA:110000, AU:118000, DE:80000,  IE:80000,  NL:80000,  SG:102000, AE:260000, PT:38000,  MX:420000,   TH:1100000,  GR:35000,  CO:60000000,  PA:58000, KR:75000000,  CZ:1050000,  GE:55000,  VN:480000000,  HR:42000,  CR:24000000,  PL:150000,  AT:60000,  BE:68000,  BR:160000, DK:600000, FI:62000,  FR:52000,  IN:1300000, IT:40000,  JP:8000000,  MY:100000, NZ:105000, NO:760000, ES:42000,  SE:640000, CH:132000, EE:28000,  CY:28000,  HU:6000000,   RO:72000,   RS:1296000,   ZA:480000,  AR:16000,  ID:132000000,  IS:11590000, MT:48500, SA:212000, QA:176000, IL:322000, CL:18100000, PH:555000, SI:45500, LU:80500, BG:42500 },
};
...
// ─── Benchmark data ───────────────────────────────────────────────────────────
const PPP_INDEX: Record<string, number> = { UK:88, US:100, CA:92, AU:95, DE:97, IE:90, NL:96, SG:104, AE:115, PT:78, MX:48, TH:42, GR:75, CO:36, PA:68, KR:82, CZ:72, GE:38, VN:32, HR:66, CR:55, PL:65, AT:96, BE:94, BR:40, DK:98, FI:92, FR:90, IN:22, IT:80, JP:84, MY:52, NZ:88, NO:107, ES:80, SE:96, CH:120, EE:72, CY:80, HU:62, RO:55, RS:48, ZA:45, AR:38, ID:35 };
const AVG_RENT_MONTHLY: Record<string, number> = { UK:1850, US:2400, CA:2100, AU:2300, DE:1300, IE:2000, NL:1800, SG:3200, AE:6500, PT:1100, MX:950, TH:850, GR:900, CO:530, PA:1200, KR:900, CZ:1050, GE:650, VN:560, HR:700, CR:970, PL:1000, AT:1350, BE:1500, BR:650, DK:1900, FI:1400, FR:1600, IN:350, IT:1100, JP:1200, MY:700, NZ:2000, NO:1800, ES:1100, SE:1700, CH:2200, EE:700, CY:900, HU:230000, RO:3000, RS:75000, ZA:15000, AR:700, ID:8000000 };
...
function calcEE(g: number) {
  const d = TAX_DATA.EE;
  const it = g * 0.20;
  const ss = g * d.socialSecurity;
  const total = it + ss;
  return { items: [{ label: "Income Tax (flat 20%)", v: it }, { label: "Social Tax (employee)", v: ss }], total, net: g - total, rate: total / g };
}

function calcCY(g: number) {
  const d = TAX_DATA.CY;
  const pa = (d as any).personalAllowance ?? 19500;
  const taxable = Math.max(0, g - pa);
  const it = calcBanded(taxable, d.bands);
  const ss = g * d.socialSecurity;
  const total = it + ss;
  return { items: [{ label: "Income Tax", v: it }, { label: "Social Insurance (GeSY)", v: ss }], total, net: g - total, rate: total / g };
}

function calcHU(g: number) {
  const d = TAX_DATA.HU;
  const it = g * 0.15;
  const ss = g * d.socialSecurity;
  const total = it + ss;
  return { items: [{ label: "Income Tax (flat 15%)", v: it }, { label: "Social Contribution", v: ss }], total, net: g - total, rate: total / g };
}

function calcRO(g: number) {
  // Romania: SS 35% on gross, then 10% income tax on (gross - SS)
  const ss = g * TAX_DATA.RO.socialSecurity;
  const taxable = Math.max(0, g - ss);
  const it = taxable * 0.10;
  const total = ss + it;
  return { items: [{ label: "Income Tax (10% of net)", v: it }, { label: "Social Contributions (CAS + CASS)", v: ss }], total, net: g - total, rate: total / g };
}

function calcRS(g: number) {
  const d = TAX_DATA.RS;
  const it = g * 0.10;
  const ss = g * d.socialSecurity;
  const total = it + ss;
  return { items: [{ label: "Income Tax (flat 10%)", v: it }, { label: "Social Contributions", v: ss }], total, net: g - total, rate: total / g };
}

function calcZA(g: number) {
  const d = TAX_DATA.ZA;
  const raw = calcBanded(g, d.bands);
  const rebate = (d as any).rebate ?? 17235;
  const it = Math.max(0, raw - rebate);
  const ss = g * d.socialSecurity;
  const total = it + ss;
  return { items: [{ label: "Income Tax (SARS)", v: it }, { label: "UIF (1%)", v: ss }], total, net: g - total, rate: total / g };
}

function calcAR(g: number) {
  const d = TAX_DATA.AR;
  const it = calcBanded(g, d.bands);
  const ss = g * d.socialSecurity;
  const total = it + ss;
  return { items: [{ label: "Income Tax (Ganancias)", v: it }, { label: "Social Security", v: ss }], total, net: g - total, rate: total / g };
}

function calcID(g: number) {
  const d = TAX_DATA.ID;
  const taxable = Math.max(0, g - (d as any).personalDeduction);
  const it = calcBanded(taxable, d.bands);
  const ss = g * d.socialSecurity;
  const total = it + ss;
  return { items: [{ label: "Income Tax (PPh21)", v: it }, { label: "BPJS (Social Security)", v: ss }], total, net: g - total, rate: total / g };
}

function calcIS(g: number) {
  const d = TAX_DATA.IS;
  const it = calcBanded(g, d.bands);
  const ss = g * d.socialSecurity;
  const total = it + ss;
  return { items: [{ label: "Income Tax", v: it }, { label: "Pension Contribution", v: ss }], total, net: g - total, rate: total / g };
}

function calcMT(g: number) {
  const d = TAX_DATA.MT;
  const it = calcBanded(g, d.bands);
  const ss = g * d.socialSecurity;
  const total = it + ss;
  return { items: [{ label: "Income Tax", v: it }, { label: "Social Security (Class 1)", v: ss }], total, net: g - total, rate: total / g };
}

function calcSA(_g: number) {
  return { items: [{ label: "Income Tax", v: 0 }], total: 0, net: _g, rate: 0 };
}

function calcQA(_g: number) {
  return { items: [{ label: "Income Tax", v: 0 }], total: 0, net: _g, rate: 0 };
}

function calcIL(g: number) {
  const d = TAX_DATA.IL;
  const it = calcBanded(g, d.bands);
  const ss = g * d.socialSecurity;
  const total = it + ss;
  return { items: [{ label: "Income Tax", v: it }, { label: "Bituach Leumi (National Insurance)", v: ss }], total, net: g - total, rate: total / g };
}

function calcCL(g: number) {
  const d = TAX_DATA.CL;
  const it = calcBanded(g, d.bands);
  const ss = g * d.socialSecurity;
  const total = it + ss;
  return { items: [{ label: "Income Tax", v: it }, { label: "Social Security (AFP)", v: ss }], total, net: g - total, rate: total / g };
}

function calcPH(g: number) {
  const d = TAX_DATA.PH;
  const it = calcBanded(g, d.bands);
  const ss = g * d.socialSecurity;
  const total = it + ss;
  return { items: [{ label: "Income Tax", v: it }, { label: "SSS / PhilHealth / Pag-IBIG", v: ss }], total, net: g - total, rate: total / g };
}

function calcSI(g: number) {
  const d = TAX_DATA.SI;
  const it = calcBanded(g, d.bands);
  const ss = g * d.socialSecurity;
  const total = it + ss;
...
function calcBG(g: number) {
  const d = TAX_DATA.BG;
  const it = calcBanded(g, d.bands);
  const ss = g * d.socialSecurity;
  const total = it + ss;
  return { items: [{ label: "Income Tax (Flat 10%)", v: it }, { label: "Social Security", v: ss }], total, net: g - total, rate: total / g };
}
...
function calcCountry(c: keyof typeof TAX_DATA, g: number) {
  switch (c) {
    ...
    case "EE": return calcEE(g);
    case "CY": return calcCY(g);
    case "HU": return calcHU(g);
    case "RO": return calcRO(g);
    case "RS": return calcRS(g);
    case "ZA": return calcZA(g);
    case "AR": return calcAR(g);
    case "ID": return calcID(g);
    case "IS": return calcIS(g);
    case "MT": return calcMT(g);
    case "SA": return calcSA(g);
    case "QA": return calcQA(g);
    case "IL": return calcIL(g);
    case "CL": return calcCL(g);
    case "PH": return calcPH(g);
    case "SI": return calcSI(g);
    case "LU": return calcLU(g);
    case "BG": return calcBG(g);
  }
}
