...
export const metadata = {
  ...
  openGraph: {
    ...
    description: 'Compare rent, salaries, healthcare, nightlife and visa routes across 55 global cities. Real data for professionals considering a move abroad.',
    images: [{ url: '/og-image.png', width: 1200, height: 630 }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Cities · Origio — Cost of Living & Expat Guides',
    description: 'Compare rent, salaries, healthcare and visa routes across 55 global cities.',
  },
