...
import { Globe2, LogOut, Trash2, Mail, Lock, Eye, EyeOff } from 'lucide-react'
    ...
    <div className="min-h-screen bg-bg-primary">
      ...
      <div className="max-w-2xl mx-auto px-6 py-12">
          ...
          {savesLoading ? (
            ...
            <div className="space-y-2">
              {savedCountries.map((save) => (
                ...
                >
                  <a
                    href={`/country/${save.country_slug}`}
        ...
        <div className="glass-panel rounded-2xl p-6 mb-10">
          <h2 className="font-heading text-lg font-bold mb-4 text-text-primary">Last Wizard Result</h2>
          <div className="text-center py-6">
