...
const PROFESSION_MAP: Record<string, { title: string; salaryRatio: number }> = {
  ...
  "cape-town":    { title: "software engineer",    salaryRatio: 0.92 },
  malaga:         { title: "software engineer",    salaryRatio: 0.88 },
  tbilisi:        { title: "remote developer",     salaryRatio: 0.85 },
  "buenos-aires": { title: "software engineer",    salaryRatio: 0.90 },
  "da-nang":      { title: "freelance developer",  salaryRatio: 0.78 },
  ...
  bristol:        { title: "software engineer",    salaryRatio: 0.92 },
  glasgow:        { title: "software engineer",    salaryRatio: 0.88 },
  ...
  utrecht:        { title: "software engineer",    salaryRatio: 0.97 },
  "the-hague":    { title: "finance analyst",      salaryRatio: 0.98 },
  cologne:        { title: "software engineer",    salaryRatio: 0.95 },
  frankfurt:      { title: "finance analyst",      salaryRatio: 1.08 },
  valencia:       { title: "UX designer",          salaryRatio: 0.78 },
  seville:        { title: "digital marketer",     salaryRatio: 0.70 },
  bilbao:         { title: "software engineer",    salaryRatio: 0.84 },
  florence:       { title: "fashion designer",     salaryRatio: 0.80 },
  osaka:          { title: "UX designer",          salaryRatio: 0.88 },
  kyoto:          { title: "UX designer",          salaryRatio: 0.85 },
  fukuoka:        { title: "UX designer",          salaryRatio: 0.84 },
  brisbane:       { title: "software engineer",    salaryRatio: 0.96 },
  perth:          { title: "software engineer",    salaryRatio: 0.95 },
  calgary:        { title: "software engineer",    salaryRatio: 0.93 },
};
