...
import { Search, Menu, X, User, Sparkles, Bookmark, Calculator } from "lucide-react";
        ...
        <div className="flex items-center justify-between h-14">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <Link
              ...
              className="flex items-center gap-1.5 text-sm font-bold text-text-muted hover:text-text-primary transition-colors uppercase tracking-wide"
            >
